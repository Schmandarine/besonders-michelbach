...
function besonders_brombach_scripts() {
	...
	wp_enqueue_style( 'besonders-brombach-bootstrap', get_template_directory_uri( ) . '/custom_bootstrap.css' );
	wp_enqueue_style( 'besonders-brombach-style', get_stylesheet_uri(  ) );
	
	//wp_enqueue_script( 'besonders-brombach-aos-aniscroll', get_template_directory_uri() . '/node_modules/aos/dist/aos.js', array( ), '' , true );
