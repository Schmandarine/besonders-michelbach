...
export const mapLeafletComponent = () => {
    document.addEventListener("DOMContentLoaded", function () {
        ...
        var popupContent1 = '<div style="width:120px"><img src="../wp-content/themes/besonders-michelbach/assets/dist/img/michelbach-logo-footer.png" class="my-2" alt=""></div>',
            popup1 = new L.Popup({
                closeOnClick: false,
                autoClose: false,
                closeButton: false
